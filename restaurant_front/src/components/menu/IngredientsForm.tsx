...
const IngredientsForm: React.FC<IngredientsFormProps> = ({ ingredients, onIngredientsChange }) => {
  ...
  const [ingredientOptions, setIngredientOptions] = useState<
    { raw_ingredient_id: string; name: string; merma?: number }[]
  >([]);
      ...
      <Stack gap="4">
        ...
        >
          {loadingOptions ? (
            ...
            <ChakraSelect.Root
              value={
                currentIngredient.raw_ingredient_id ? [currentIngredient.raw_ingredient_id] : []
              }
        ...
        <Stack direction="row" gap="4">
          ...
          <CustomField label="Unidad" required>
            <select
          ...
          <CustomField label="Merma (%)">
            <Input value={currentIngredient.merma} name="merma" type="number" readOnly disabled />
          </CustomField>
          <CustomField
            label="Precio"
            required
            ...
            <Box borderWidth={1} borderRadius="md" overflow="hidden">
              ...
              {ingredients.map((ingredient, index) => (
                <Grid
                  ...
                  alignItems="center"
                >
                  <GridItem style={{ whiteSpace: 'nowrap', minWidth: 120 }}>
                    {ingredient.name}
                  </GridItem>
                  ...
                  <GridItem textAlign="right">
                    {ingredient.merma !== undefined
                      ? ((ingredient.merma ?? 0) * 100).toFixed(2)
                      : ''}
                  </GridItem>
                  <GridItem textAlign="right">
